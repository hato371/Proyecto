...
/// dialogs.
///
/// /// Un diálogo de diseño de materiales.
// ///
// /// Este widget de diálogo no tiene ninguna opinión sobre el contenido del
// /// diálogo. En lugar de usar este widget directamente, considere usar [AlertDialog]
// /// o [SimpleDialog], que implementan tipos específicos de diseño de materiales
// /// diálogos.
///
/// See also:
///
...
/// Una opción utilizada en un [SimpleDialog].
///
/// Un simple diálogo ofrece al usuario la posibilidad de elegir entre varias opciones. Esto
/// el widget se usa comúnmente para representar cada una de las opciones. Si el usuario
/// selecciona esta opción, el widget llamará a la devolución de llamada [onPressed], que
/// normalmente usa [Navigator.pop] para cerrar el diálogo.
/// El relleno en un [SimpleDialogOption] está configurado para combinar con el
/// predeterminado [SimpleDialog.contentPadding] para que cada opción termine en 8 píxeles
/// desde el otro verticalmente, con 20 píxeles de espacio entre los diálogos
/// título y la primera opción, y 24 píxeles de espacio entre la última opción
/// y la parte inferior del diálogo.
...
class SimpleDialogOption extends StatelessWidget {
  ...
  /// La devolución de llamada que se llama cuando se selecciona esta opción.
  ///
  /// Si se establece en nulo, la opción no se puede seleccionar.
  ///
  /// Cuando se usa en un [SimpleDialog], normalmente llamará a [Navigator.pop]
  /// con un valor para [showDialog] para completar su futuro.
